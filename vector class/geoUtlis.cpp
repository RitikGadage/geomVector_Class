...
int jmk::orientation3d(const Vector3f& a, const Vector3f& b, const Vector3f& c)
{
...
double jmk::areaTriangle2d(const Point2d& a, const Point2d& b, const Point2d& c)
{
	auto ab = b - a;
	auto ac = c - a;
	auto crossproduct = jmk::crossProduct2d(ab, ac);

	auto area = 0.5 * crossproduct;
	return area;
}
...
/*
double jmk::areaTriangle2d(const Vector2f& a, const Vector2f& b, const Vector2f& c)
{
	Vector2f ab = b - a;
	Vector2f ac = c - a;
	auto crossproduct = jmk::crossProduct2d(ab, ac);

	double area = 0.5 * crossproduct;
	return area;
}
*/


double jmk::areaTriangle3d( const Vector3f& a,  const Vector3f& b,  const Vector3f& c)
{
	Vector3f ab = b - a;
	Vector3f ac = c - a;
	auto crossproduct = jmk::crossProduct3d(ab, ac);
